 ...
 <div class="main-panel">
 	<div class="content-wrapper">
       ...
       <div class="col-lg-12 stretch-card">
         <div class="card">
           <div class="card-body">
             <h4 class="card-title">History pengguna</h4>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr class="table-info">
                  ...
                  <td>
                  <a href="editpengguna.php?id_pengguna=<?php echo $row['id_pengguna']?>" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash">edit</span></a>
